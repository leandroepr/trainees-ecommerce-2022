  ...
  return (
    <Column className='w-full'>
      ...
      <Row className="pt-16 justify-end">
        <Button contentButton="Cancelar a compra" className='mr-2 border border-info text-info py-1 px-4 rounded' />
        <Button contentButton="Continuar a compra" className='bg-info text-light py-1 px-4 rounded' />
      </Row>
    </Column >
  )
}
